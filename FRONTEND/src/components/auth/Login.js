...
function Login() {
    ...
    return (
        <div style={{ height: "100vh" }} className="h-full bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 w-full py-6 px-4">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} aria-label="enter email adress" role="input" type="email" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        <div className="mt-6  w-full">
                            <lable className="text-sm font-medium leading-none text-gray-800">Password</lable>
                            <div className="relative flex items-center justify-center">
                                <input onChange={(e) => setPassword(e.target.value)} aria-label="enter Password" role="input" type={show ? "text" : "password"} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
