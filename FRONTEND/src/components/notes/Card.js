    ...
    >
      ...
      <div>
        <div className=" flex items-center justify-between text-gray-800 dark:text-gray-100">
          ...
          <div style={{position:"absolute", bottom:"10px", right:"10px"}} className="w-12 h-12 rounded-full bg-gray-800 dark:bg-gray-100 dark:text-gray-800 text-white flex items-center justify-center">
            <Link to={`/note/delete/${id}`}>
                 delete
            </Link>
          </div>
        </div>
